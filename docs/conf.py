...
project = "bgflow"
copyright = (
    "2021, noegroup. Project structure based on the "
...
latex_documents = [
    (master_doc, "bgflow.tex", "bgflow Documentation", "bgflow", "manual"),
]
...
man_pages = [(master_doc, "bgflow", "bgflow Documentation", [author], 1)]
