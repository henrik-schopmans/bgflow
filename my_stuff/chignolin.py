...
temperatures = [250.0, 274.64013583, 301.70881683, 331.44540173, 364.11284061, 400.0]
...
for current_temperature in temperatures:
    ...
    dataset = ChignolinOBC2PT(
        download=not is_data_here, read=True, temperature=current_temperature
    )
    ...
    if False:
        ...
        np.save(
            "/home/henrik/Dokumente/Archive/Big_Files/single/chignolin_implicit_noe/"
            + temperature_str
            + ".npy",
            coordinates,
        )
